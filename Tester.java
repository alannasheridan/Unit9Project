...
public class Tester{
    public static void main(String[] args){
        ...
        Plant p4 = new Succulent(11,  4, true, 8, true);
        Succulent p5 = new Succulent(4, 8, false, 3, false);
        ChineseMoneyPlant p6 = new ChineseMoneyPlant(5, 2, true, 2, true, "green","black");
        ChineseMoneyPlant p7 = new ChineseMoneyPlant(10, 10, false, 2, true, "yellow", "black");
        Plant p8 = new ChineseMoneyPlant(6, 4, true, 1, false, "green", "red");
        ChineseMoneyPlant p9 = new ChineseMoneyPlant(14, 8, true, 10, true, "yellow", "green");
        Plant p10 = p6;
        ...
        System.out.println("\t-" + p5.sunExposure());
        ...
        System.out.println("\t-" + p6.sunExposure());
        ...
        System.out.println("\t-" + p7.sunExposure());
        ...
        System.out.println("\t-" + p9.sunExposure());
